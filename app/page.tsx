...

{
  return (
    <main className="flex flex-col">
      <div className="bg-customBG1 absolute h-[70vh] lg:h-[80vh] w-full object-cover object-right">
        ...
        <div className='flex justify-center'>
          <Link className='btn btn-primary w-40' href="/editor/new-editor">Try it</Link>
        </div>
